...
class SerialNumberImportWizard(models.TransientModel):
    ...
    def import_serial_numbers(self):
        ...
        for line in lines:
            ...
            if operation.picking_id.picking_type_code == 'incoming':
                production_lot.is_receipt_done = True
            if operation.picking_id.picking_type_code == 'outgoing':
                production_lot.is_delivery_done = True
